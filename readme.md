# **Generative Adversarial Network (GAN) for Image Colorization**

## 📖 About
This project implements a Generative Adversarial Network (GAN) for the task of image colorization. The architecture consists of two main components—a **Generator** that tries to generate  colored images from gray-scale inputs, and a **Discriminator** which is supposed to discriminate between real color images and those generated by the Generator. The model is trained to enhance the quality of generated images over time, gradually producing realistic colorized images from grayscale inputs.
